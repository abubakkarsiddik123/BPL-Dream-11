...
const Banner = () => {
 ...
 <div className='flex items-center justify-center'>
    ...
    <p className='text-[#FFFFFFB3] text-2xl font-medium'>Beyond Boundaries Beyond Limits</p>
    <button className='btn bg-[#E7FE29] rounded-xl text-[#131313] font-bold '>Claim Free Credit</button>
  </div>
 </div>
